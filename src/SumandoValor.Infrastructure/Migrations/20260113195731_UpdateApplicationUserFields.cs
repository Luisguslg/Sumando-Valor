        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscapacidadDescripcion = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    ...
                    CanalConocio = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlataformaDigital = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    FacilitadorTexto = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificados_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Certificados_Talleres_TallerId",
                        column: x => x.TallerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScorePromedio = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EncuestasSatisfaccion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EncuestasSatisfaccion_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EncuestasSatisfaccion_Talleres_TallerId",
                        column: x => x.TallerId,
                        principalTable: "Talleres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificados_ApplicationUserId",
                table: "Certificados",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Certificados_TallerId",
                table: "Certificados",
                column: "TallerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EncuestasSatisfaccion_ApplicationUserId",
                table: "EncuestasSatisfaccion",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EncuestasSatisfaccion_TallerId",
                table: "EncuestasSatisfaccion",
                column: "TallerId");

            migrationBuilder.CreateIndex(
                name: "IX_EncuestasSatisfaccion_UserId",
                table: "EncuestasSatisfaccion",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_TallerId_UserId",
                table: "Inscripciones",
                columns: new[] { "TallerId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_UserId",
                table: "Inscripciones",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MensajesContacto_CreatedAt",
